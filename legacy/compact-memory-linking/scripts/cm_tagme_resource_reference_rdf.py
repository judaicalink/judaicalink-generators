...
cm_tagme_resources.serialize(destination="../output/cm_tagme_resources.ttl", format="ttl")
cm_tagme_references.serialize(destination="../output/cm_tagme_references.ttl", format="ttl")
