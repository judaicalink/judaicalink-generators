...
graphuni.serialize(destination='../output/generated_persons_DBPedia-enriched-02.ttl',
                   format="turtle")  # the second generated file all the other infomration were added
