...
# graph.serialize(destination='../output/Entityfacts-freimann-sameas.ttl', format="turtle")
# graph.serialize(destination='../output/Entityfacts-gnd-sameas.ttl', format="turtle")
graph.serialize(destination='../output/Entityfacts-ubgnd-sameas.ttl', format="turtle")
# graph.serialize(destination='../output/Entityfacts-bhr-sameas.ttl', format="turtle")
