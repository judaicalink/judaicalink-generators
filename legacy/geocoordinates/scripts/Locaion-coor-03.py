...
graph1.serialize(destination='../output/city-geocoor-05.ttl', format="turtle")
graph2.serialize(destination='../output/city-geocoor-06.ttl', format="turtle")
graph3.serialize(destination='../output/city-geocoor-07.ttl', format="turtle")
