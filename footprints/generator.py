                        ...
                        if contains_non_digits(name) == True:
                            ...
                            if 'birth_date' in date:
                                    try:                                                              #clean and add birthdate
                                        ...
                                        print('ERROR2 Birthdate der ID: ', date['id'], name, 'ist vom Typ ', type(birth_date),birth_date)
                            if 'death_date' in date:
                                    try:                                                              #clean and add birthdate
                                        ...
                                        print('ERROR2 Birthdate der ID: ', date['id'], name, 'ist vom Typ ', type(death_date),death_date)
                                    ...
                                    try:
                                        ...
                                        if idf is not None:
                                            if idf['authority'] == "VIAF Identifier":
                                                ...
                                                print('Seite:', i, ', ', name,', identifier = ', idf['authority'])
                                    except:
                                        pass
