#Maral Dadvar
#09/01/2019
#This script removes the authors whose birth dates don't match with the publication date
...
for ubitem in result: #names from UB Freimann

   urilist.append(ubitem[0])
...
graphout.serialize(destination = 'cm-uni-name-filter-complete.ttl' , format="turtle")
