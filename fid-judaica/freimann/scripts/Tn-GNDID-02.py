# Maral Dadvar
#This code looks for common authors in Tn authors at UB dataset and the authors extracted from GND with unique ocurance. No occupation is specified, only unique names are extarcted.
#13.07.2017
#Ver. 01
...
graphmulti.serialize(destination='Tn-gnd-multi-2.rdf', format="turtle")
graphuni.serialize(destination='Tn-gnd-uni-2.rdf', format="turtle")
